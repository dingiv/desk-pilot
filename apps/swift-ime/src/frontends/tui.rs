...
use ime_core::fsm::control::KeyKind;
...
impl SharedIme {
    ...
    fn render_meta(&self) -> (Vec<ime_core::family::RankedCandidate>, ime_core::fsm::control::StateFlags) {
...
fn render(
    ...
    flags: ime_core::fsm::control::StateFlags,
) {
    let area = f.area();
